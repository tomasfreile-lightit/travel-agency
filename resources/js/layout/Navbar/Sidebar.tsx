        ...
        <nav className="flex flex-1 flex-col">
          <ul className="flex flex-1 flex-col gap-y-7">
              ...
              <ul className="relative -mx-2 h-full space-y-1">
                ...
                <li className="absolute bottom-0 w-full">
                  <button
                    ...
                    className="group flex w-full gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold text-gray-400 hover:bg-gray-800 hover:text-white"
                  >
            ...
            <li className="-mx-6 mt-auto">
              <Link
                to="#"
                className="flex items-center gap-x-4 px-6 py-3 text-sm leading-6 font-semibold text-white hover:bg-gray-800"
              >
                <img
