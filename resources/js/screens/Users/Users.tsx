...
export const Users = () => {
  ...
  return (
    <div className="bg-gray-900">
      <h2 className="flex items-center justify-between px-4 py-9 text-base leading-7 font-semibold text-white sm:px-6 lg:px-8">
        Latest activity
        <Button
          variant="secondary"
          // TODO: open modal here instead of previous navigation to modal route
            ...
            <tr key={item.commit}>
              <td className="py-4 pr-8 pl-4 sm:pl-6 lg:pl-8">
                <div className="flex items-center gap-x-4">
                  ...
                  />
                  <div className="truncate text-sm leading-6 font-medium text-white">
                    {item.user.name}
                  </div>
                </div>
              </td>
              ...
              <td className="py-4 pr-4 pl-0 text-sm leading-6 sm:pr-8 lg:pr-20">
              ...
              <td className="hidden py-4 pr-8 pl-0 text-sm leading-6 text-gray-400 md:table-cell lg:pr-20">
                {item.duration}
              </td>

              <td className="hidden py-4 pr-4 pl-0 text-right text-sm leading-6 text-gray-400 sm:table-cell sm:pr-6 lg:pr-8">
