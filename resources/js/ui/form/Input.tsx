    ...
    <div className={tw("relative", containerClassName)}>
      ...
      >
        ...
        <input
          ...
          {...rest}
          className={tw(
            "block w-full rounded-md border border-gray-300 bg-gray-800 px-3 py-2 text-sm text-gray-50 placeholder:text-gray-400 focus:ring-1 focus:ring-blue-500 focus:outline-none",
